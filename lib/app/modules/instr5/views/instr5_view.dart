            ...
            children: [
             ...
             child: Text(
              ...
              Padding(
                padding: EdgeInsets.only(top: 20, left: 200, right: 150),
                child: Text(
                'Легкость использования, реалистичные прототипы, коллаборация и обратная связь, интеграция с другими инструментами',   style: TextStyle(
                   fontSize: 20,
                    fontWeight: FontWeight.w800,
                    color: Colors.white),
             ),),
