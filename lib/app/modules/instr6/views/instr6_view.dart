          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                    'Функционал Autodesk AutoCAD позволяет проектировать различные элементы и объекты в 2D и 3D. Пользователи могут создавать собственные производственные чертежи, реалистичные изображения моделей, применяя к ним цвета и текстуры. Можно анимировать эти объекты.',
                    style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.w800,
                        color: Colors.white)),
              ...
              Padding(
                padding: EdgeInsets.only(top: 20, left: 200, right: 150),
                child: Text(
                  'Опыт, внутренний язык программирования, виртуализация объектов.',
                  style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.w800,
                      color: Colors.white),
              ...
              ElevatedButton(
                onPressed: () {
                  launch('https://www.autodesk.com/products/autocad/overview');
                },
                child: Container(
                  width: 300,
